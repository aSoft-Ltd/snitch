...
subprojects {
    ...
    configure<MavenPublishBaseExtension> {
        ...
        pom {
            ...
            url.set("https://github.com/aSoft-Ltd/snitch")
            licenses {
                license {
                    name.set("MIT License")
                    url.set("https://github.com/aSoft-Ltd/snitch/blob/master/LICENSE")
                }
            }
            developers {
                developer {
            ...
            scm {
                url.set("https://github.com/aSoft-Ltd/snitch/")
                connection.set("scm:git:git://github.com/aSoft-Ltd/snitch.git")
                developerConnection.set("scm:git:ssh://git@github.com/aSoft-Ltd/snitch.git")
            }
        }
    }
}
